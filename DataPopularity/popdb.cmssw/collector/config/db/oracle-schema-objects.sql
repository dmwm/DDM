...
CREATE TABLE T_RAW_CMSSW(
    ...
    START_TIME                NUMBER,
    END_TIME                  NUMBER,
    START_DATE                DATE GENERATED ALWAYS AS (CAST(TIMESTAMP' 1970-01-01 00:00:00.000000000'+NUMTODSINTERVAL(START_TIME,'second') AS DATE)) ,
    END_DATE                  DATE GENERATED ALWAYS   AS (CAST(TIMESTAMP' 1970-01-01 00:00:00.000000000'+NUMTODSINTERVAL(END_TIME,'second') AS DATE)) ,
