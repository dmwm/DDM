...
SECRET_KEY = '6hwy^frcl_)a-+l5tv7!5fx1!agb%x7qe-=8rmoy^#um$*tnx@'
...
CACHES = {
    ...
    'default': {
        ...
        'LOCATION': popsettings.getSetting("popularity_project", "MEMCACHED_SERVER"),
    },

    'onfile': {
        'BACKEND': 'django.core.cache.backends.filebased.FileBasedCache',
        'LOCATION': popsettings.getSetting("popularity_project", "CACHE_DIR")+'/Popularity_cache',
    }
}
